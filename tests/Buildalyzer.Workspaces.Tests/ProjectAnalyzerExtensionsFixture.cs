    ...
    public class ProjectAnalyzerExtensionsFixture
    {
        ...
        public void LoadsWorkspace()
        {
            ...
            IProjectAnalyzer analyzer =
                GetProjectAnalyzer(@"projects\SdkNetStandardProject\SdkNetStandardProject.csproj", log);
            ...
            workspace.CurrentSolution.Projects.First().Documents
                .ShouldContain(x => x.Name == "Class1.cs", log.ToString());
        }
        ...
        public void AddsProjectReferences(bool addProjectReferences, int totalProjects)
        {
            ...
            IProjectAnalyzer analyzer =
                GetProjectAnalyzer(
                    @"projects\LegacyFrameworkProjectWithReference\LegacyFrameworkProjectWithReference.csproj", log);
        ...
        public void AddsTransitiveProjectReferences(bool addProjectReferences, int totalProjects)
        {
            ...
            SafeStringWriter log = new SafeStringWriter();
            IProjectAnalyzer analyzer =
                GetProjectAnalyzer(@"projects\TransitiveProjectReference\TransitiveProjectReference.csproj", log);
        ...
        public async Task SupportsConstants()
        {
            ...
            IProjectAnalyzer analyzer =
                GetProjectAnalyzer(
                    @"projects\SdkNetStandardProjectWithConstants\SdkNetStandardProjectWithConstants.csproj", log);
        ...
        public void SupportsAnalyzers()
        {
            ...
            IProjectAnalyzer analyzer =
                GetProjectAnalyzer(
                    @"projects\SdkNetCore2ProjectWithAnalyzer\SdkNetCore2ProjectWithAnalyzer.csproj",
                    log);
            ...
            string logged = log.ToString();
            logged.ShouldNotContain("Workspace failed");
            project.AnalyzerReferences.ShouldContain(
                reference => reference.Display == "Microsoft.CodeQuality.Analyzers");
        }
        ...
        public void SupportsAdditionalFiles()
        {
            ...
            SafeStringWriter log = new SafeStringWriter();
            IProjectAnalyzer analyzer =
                GetProjectAnalyzer(@"projects\ProjectWithAdditionalFile\ProjectWithAdditionalFile.csproj", log);
        ...
        public async Task SupportsNullabilityEnabled()
        {
            ...
            IProjectAnalyzer analyzer =
                GetProjectAnalyzer(@"projects\NullabilityEnabled\NullabilityEnabled.csproj", log);
        ...
        public void HandlesWpfCustomControlLibrary()
        {
            ...
            SafeStringWriter log = new SafeStringWriter();
            IProjectAnalyzer analyzer =
                GetProjectAnalyzer(@"projects\WpfCustomControlLibrary1\WpfCustomControlLibrary1.csproj", log);
        ...
        private IProjectAnalyzer GetProjectAnalyzer(
            string projectFile,
            StringWriter log,
